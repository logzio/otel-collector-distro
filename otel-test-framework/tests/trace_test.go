...
import (
	...
	"github.com/yotamloe/logzio-otel-distro/otel-test-framework/customdatareceivers"
...
func TestTrace10kSPS(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			customdatareceivers.NewMockLogzioTraceDataReceiver(testbed.GetAvailablePort(t)),
...
func TestStabilityTracesOTLPLogzio(t *testing.T) {
...
func verifySingleSpan(
	...
	span.SetTraceID(UInt64ToTraceID(0, 1))
